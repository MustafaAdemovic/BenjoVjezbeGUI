...
public class Guigui extends JPanel implements ActionListener{
	...
	public static void main(String[] args) {
		...
		Timer t = new Timer(100, drawPanel);
		t.start();
	...
	public void paintComponent(Graphics g) {
		...
		g.fillOval(50 - frame, 50 - frame, 50, 50);// Određujemo dimenzije i koordinate
		paintComponent2(g);
	...
	public void paintComponent2(Graphics a) {
		...
		a.fillRect(250 - frame ,150 + frame , 50, 50);// Određujemo dimenzije i koordinate

	}// Kraj metode paintComponent2

	/**
	 * U metodi actionPerformed povećavamo frame svaki put za 1 tako da
	 * omogućavamo tijelima unutar ovog prozora kretanje
	 */
	@Override
